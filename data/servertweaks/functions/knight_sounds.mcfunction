...
execute at @s if score @s cooldownTimer matches 400 run playsound minecraft:entity.generic.extinguish_fire master @a ~ ~ ~ 20 0.5
execute at @s if score @s cooldownTimer matches 440 run playsound minecraft:entity.generic.extinguish_fire master @a ~ ~ ~ 20 0.5
execute at @s if score @s cooldownTimer matches 480 run playsound minecraft:entity.generic.extinguish_fire master @a ~ ~ ~ 20 0.5
execute at @s if score @s cooldownTimer matches 520 run playsound minecraft:entity.generic.extinguish_fire master @a ~ ~ ~ 20 0.5
execute at @s if score @s cooldownTimer matches 560 run playsound minecraft:entity.generic.extinguish_fire master @a ~ ~ ~ 20 0.5