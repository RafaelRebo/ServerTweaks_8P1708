...
execute if score @s cooldownTimer matches 40 run title @s actionbar {"text":"¡18 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 60 run title @s actionbar {"text":"¡17 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 80 run title @s actionbar {"text":"¡16 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 100 run title @s actionbar {"text":"¡15 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 120 run title @s actionbar {"text":"¡14 segundos de enfriamiento!","color":"red"} 
execute if score @s cooldownTimer matches 140 run title @s actionbar {"text":"¡13 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 160 run title @s actionbar {"text":"¡12 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 180 run title @s actionbar {"text":"¡11 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 200 run title @s actionbar {"text":"¡10 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 220 run title @s actionbar {"text":"¡9 segundos de enfriamiento!","color":"red"} 
execute if score @s cooldownTimer matches 240 run title @s actionbar {"text":"¡8 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 260 run title @s actionbar {"text":"¡7 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 280 run title @s actionbar {"text":"¡6 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 300 run title @s actionbar {"text":"¡5 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 320 run title @s actionbar {"text":"¡4 segundos de enfriamiento!","color":"red"} 
execute if score @s cooldownTimer matches 340 run title @s actionbar {"text":"¡3 segundos de enfriamiento!","color":"red"}
