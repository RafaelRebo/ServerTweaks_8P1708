...
execute if score @s cooldownTimer matches 40 run title @s actionbar {"text":"¡8 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 60 run title @s actionbar {"text":"¡7 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 80 run title @s actionbar {"text":"¡6 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 100 run title @s actionbar {"text":"¡5 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 120 run title @s actionbar {"text":"¡4 segundos de enfriamiento!","color":"red"} 
execute if score @s cooldownTimer matches 140 run title @s actionbar {"text":"¡3 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 160 run title @s actionbar {"text":"¡2 segundos de enfriamiento!","color":"red"}
execute if score @s cooldownTimer matches 180 run title @s actionbar {"text":"¡1 segundos de enfriamiento!","color":"red"}
