...
execute as @a[tag=overcharged] run attribute @s irons_spellbooks:mana_regen base set -100000
execute as @a[tag=overcharged] at @s run particle minecraft:soul_fire_flame ~ ~ ~ 0.2 0 0.2 0.1 3 normal @a[distance=..32]
execute as @a[tag=overcharged] run scoreboard players add @s chargedTimer 1
execute as @a[tag=overcharged,scores={chargedTimer=100..}] run tag @s add inCooldown
...
execute as @a[tag=inCooldown] at @s run particle minecraft:large_smoke ~ ~ ~ 0.1 0 0.1 0.05 3 normal @a[distance=..32]
...
execute as @a[tag=!inCooldown,tag=resetmana] run attribute @s irons_spellbooks:mana_regen base set 1
execute as @a[tag=!inCooldown,tag=resetmana] run tag @s remove resetmana

execute as @a[tag=overcharged] if score @s chargedTimer matches 1 run title @s actionbar {"text":"¡5 segundos de supercarga!","color":"aqua"}
execute as @a[tag=overcharged] if score @s chargedTimer matches 20 run title @s actionbar {"text":"¡4 segundos de supercarga!","color":"aqua"} 
execute as @a[tag=overcharged] if score @s chargedTimer matches 40 run title @s actionbar {"text":"¡3 segundos de supercarga!","color":"aqua"}
execute as @a[tag=overcharged] if score @s chargedTimer matches 60 run title @s actionbar {"text":"¡2 segundos de supercarga!","color":"aqua"}
execute as @a[tag=overcharged] if score @s chargedTimer matches 80 run title @s actionbar {"text":"¡1 segundos de supercarga!","color":"aqua"}

execute as @a[tag=overcharged] if score @s chargedTimer matches 1 run playsound irons_spellbooks:entity.chain_lightning.lightning_chain master @s ~ ~ ~ 100 0.5
execute as @a[tag=overcharged] if score @s chargedTimer matches 20 run playsound irons_spellbooks:entity.chain_lightning.lightning_chain master @s ~ ~ ~ 100 0.5
execute as @a[tag=overcharged] if score @s chargedTimer matches 40 run playsound irons_spellbooks:entity.chain_lightning.lightning_chain master @s ~ ~ ~ 100 0.5
execute as @a[tag=overcharged] if score @s chargedTimer matches 60 run playsound irons_spellbooks:entity.chain_lightning.lightning_chain master @s ~ ~ ~ 100 0.5
execute as @a[tag=overcharged] if score @s chargedTimer matches 80 run playsound irons_spellbooks:entity.chain_lightning.lightning_chain master @s ~ ~ ~ 100 0.5
...
execute as @a[tag=inCooldown] if score @s cooldownTimer matches 1 run playsound minecraft:entity.generic.extinguish_fire master @s ~ ~ ~ 100 0.5
execute as @a[tag=inCooldown] if score @s cooldownTimer matches 40 run playsound minecraft:entity.generic.extinguish_fire master @s ~ ~ ~ 100 0.5
