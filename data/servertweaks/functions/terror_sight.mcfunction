...
effect give @e[tag=!Vampire,distance=..1.5] relics:bleeding 15 1 true
effect give @e[tag=!Player,type=!#servertweaks:undead,nbt=!{ActiveEffects:[{Id:7}]},distance=..1.5] minecraft:instant_damage 5 1 true
effect give @e[tag=!Player,type=#servertweaks:undead,nbt=!{ActiveEffects:[{Id:6}]},distance=..1.5] minecraft:instant_health 5 1 true